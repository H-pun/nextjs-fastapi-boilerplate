...
import { Lightbulb, RotateCcw, ZoomIn } from "lucide-react";
...
export function AvatarCropDialog({
  ...
  const { mutate: uploadAvatar, isPending: uploading } = useMutation({
    mutationFn: (uploadFile: File) => updateAvatar(uploadFile),
  ...
  return (
    ...
    >
      <DialogContent className="gap-4 p-0 sm:max-w-4xl">
        ...
        {file ? (
          <div className="grid gap-5 px-6 md:grid-cols-[3fr_2fr]">
                ...
                <Tooltip>
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <div className="text-sm font-medium">Avatar crop guide</div>
                      <p className="text-xs leading-relaxed text-muted-foreground">
                        Keep the face centered in the middle column. Place the
                        eyes near the upper third, and leave a little space above
                        the head so the avatar still feels balanced after
                        cropping.
                      </p>
                    </div>
                  </TooltipContent>
